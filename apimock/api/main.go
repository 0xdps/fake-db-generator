...
import (
	...
	"github.com/0xdps/fake-stack/apimock/api/handlers"
	"github.com/0xdps/fake-stack/apimock/api/middleware"
	"github.com/0xdps/fake-stack/apimock/api/schema"
...
func main() {
	...
	if schemasDir == "" {
		// Default to ../shared/schemas from the api directory
